...
const createWindow = (): void => {
  ...
  ipcMain.handle('getFileName', async (x, filters:any, save: boolean) => {
    return await dialogs.getFileName(filters, save);
  });
  ...
  ipcMain.handle('export', async (x, data: any, options: ExportOptions) => { 
    return await dialogs.export(data, options); 
  });
