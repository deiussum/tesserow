...
This file provides guidance to coding agents (Claude Code, OpenCode, and others) when working with code in this repository.
...
This repo uses [OpenSpec](https://github.com/Fission-AI/OpenSpec) (the `opsx` experimental workflow) to plan and track non-trivial changes as specs before they're implemented. See `CONTRIBUTING.md` for when a change needs to go through this flow versus landing as a direct fix.
